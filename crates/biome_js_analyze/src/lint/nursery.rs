...
pub mod no_simultaneous_export_of_components_and_non_components;
...
declare_group! {
    pub Nursery {
        ...
        rules : [
            ...
            self :: no_simultaneous_export_of_components_and_non_components :: NoSimultaneousExportOfComponentsAndNonComponents ,
