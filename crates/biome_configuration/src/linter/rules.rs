...
pub struct Nursery {
    ...
    #[doc = "React components and regular functions must be exported in separate files. This is necessary to enable the Fast Refresh feature, which streamlines development. If they are being exported together, the files need to be split."]
    #[serde(skip_serializing_if = "Option::is_none")]
